...
public class MultithreadingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null) {
            Multithreading_db dbHelper = new Multithreading_db(this);
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(MultithreadingActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void showSolution() {
        ...
        if (questionCounter < questionCountTotal) {
            ...
            Intent i=new Intent(MultithreadingActivity.this,Display.class);
