...
public class ServletActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null) {
            Servlet_db dbHelper = new Servlet_db(this);
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(ServletActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void showSolution() {
        ...
        if (questionCounter < questionCountTotal) {
            ...
            Intent i=new Intent(ServletActivity.this,Display.class);
    ...
    private void finishQuiz() {
        Intent resultIntent = new Intent(ServletActivity.this,StartingScreenActivity.class);
