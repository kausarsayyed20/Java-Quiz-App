...
public class JDBC1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jdbc1);
        ...
        if(savedInstanceState == null) {
            JDBC_db dbHelper = new JDBC_db(this);
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(JDBC1Activity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void showSolution() {
        ...
        if (questionCounter < questionCountTotal) {
            ...
            Intent i=new Intent(JDBC1Activity.this,Display.class);
